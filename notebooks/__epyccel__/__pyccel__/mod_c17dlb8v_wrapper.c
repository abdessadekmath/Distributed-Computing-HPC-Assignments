...
long solve_2d_linearconv_pyccel(int n0_u, int n1_u, double *u, long nt, double dt, double dx, double dy, double c);
...
PyObject *solve_2d_linearconv_pyccel_wrapper(PyObject *self, PyObject *args, PyObject *kwargs)
{
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwargs, "O!ldddd", kwlist, &PyArray_Type, &u, &nt, &dt, &dx, &dy, &c))
    {
        return NULL;
    }
    if (PyArray_NDIM(u) != 2)
    ...
    Out_0001 = solve_2d_linearconv_pyccel(PyArray_DIM(u, 0), PyArray_DIM(u, 1), PyArray_DATA(u), nt, dt, dx, dy, c);
    result = Py_BuildValue("l", Out_0001);
    return result;
}
/*........................................*/

static PyMethodDef mod_c17dlb8v_methods[] = {
    {
...
static struct PyModuleDef mod_c17dlb8v_module = {
    ...
    -1,
    mod_c17dlb8v_methods
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_c17dlb8v(void)
{
    PyObject *m;

    import_array();

    m = PyModule_Create(&mod_c17dlb8v_module);
