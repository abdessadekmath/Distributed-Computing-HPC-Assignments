!........................................
function solve_2d_nonlinearconv_pyccel(n0_u, n1_u, u, n0_v, n1_v, v, nt, &
      nx, ny, dt, dx, dy, c) bind(c) result(Out_0001)

  use mod_4jwsmhnt, only: mod_solve_2d_nonlinearconv_pyccel => &
  ...
  Out_0001 = mod_solve_2d_nonlinearconv_pyccel(u, v, nt, nx, ny, dt, dx, &
      dy, c)
