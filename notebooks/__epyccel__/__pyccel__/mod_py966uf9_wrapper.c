...
long solve_1d_diff_pyccel(int n0_u, double *u, long nt, long nx, double dt, double dx, double nu);
...
PyObject *solve_1d_diff_pyccel_wrapper(PyObject *self, PyObject *args, PyObject *kwargs)
{
    ...
    Out_0001 = solve_1d_diff_pyccel(PyArray_DIM(u, 0), PyArray_DATA(u), nt, nx, dt, dx, nu);
    result = Py_BuildValue("l", Out_0001);
    return result;
}
/*........................................*/

static PyMethodDef mod_py966uf9_methods[] = {
    {
...
static struct PyModuleDef mod_py966uf9_module = {
    ...
    -1,
    mod_py966uf9_methods
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_py966uf9(void)
{
    PyObject *m;

    import_array();

    m = PyModule_Create(&mod_py966uf9_module);
