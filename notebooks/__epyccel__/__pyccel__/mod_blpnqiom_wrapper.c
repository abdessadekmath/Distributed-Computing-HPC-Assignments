...
static PyMethodDef mod_blpnqiom_methods[] = {
    {
...
static struct PyModuleDef mod_blpnqiom_module = {
    ...
    -1,
    mod_blpnqiom_methods
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_blpnqiom(void)
{
    PyObject *m;

    import_array();

    m = PyModule_Create(&mod_blpnqiom_module);
