...
function solve_1d_burger_pyccel(u, nt, nx, dt, dx, nu) result(Out_0001)
  ...
  do n = 0_C_LONG_LONG, nt-1_C_LONG_LONG, 1_C_LONG_LONG
    ...
    u(0_C_LONG_LONG) = u(0_C_LONG_LONG) - dt / dx * u(0_C_LONG_LONG) * ( &
      u(0_C_LONG_LONG) - u(size(u, 1) - 2_C_LONG_LONG)) + nu * dt / dx &
      ** 2_C_LONG_LONG * (u(1_C_LONG_LONG) - 2_C_LONG_LONG * u( &
      0_C_LONG_LONG) + u(size(u, 1) - 2_C_LONG_LONG))
  end do
